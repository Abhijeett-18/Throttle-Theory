...
export default function Tshirts() {
  ...
  const fetchProducts = async () => {
    try {
      const response = await productsAPI.getProducts({ category: "tshirts" });
      if (response.success) {
  ...
  return (
    <div className="min-h-screen bg-[#f5f5f5]">
      ...
      {loading ? (
        ...
        <div className="flex justify-center items-center py-20">
          <div className="text-xl text-gray-600">No T-shirts found. Add products from admin dashboard.</div>
        </div>
      ) : (
