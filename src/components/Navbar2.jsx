    ...
    <nav className="px-3 sm:px-4 md:px-8 py-4 md:py-6 text-black bg-gray-200 flex justify-between items-center sticky top-0 z-50">
      <div className="flex items-center space-x-3 sm:space-x-4 md:space-x-6">
        ...
        >
          ...
          >
            <Link to="/categories/tshirts" onClick={() => setOpen(false)} className="block py-2 hover:text-gray-300 font-clash w-full text-left text-white">
              T-Shirts
            </Link>
            <Link to="/categories/caps" onClick={() => setOpen(false)} className="block py-2 hover:text-gray-300 font-clash w-full text-left text-white">
              Caps
            </Link>
            <Link to="/categories/jackets" onClick={() => setOpen(false)} className="block py-2 hover:text-gray-300 font-clash w-full text-left text-white">
              Jackets
            </Link>
            <Link to="/categories/bottoms" onClick={() => setOpen(false)} className="block py-2 hover:text-gray-300 font-clash w-full text-left text-white">
              Bottoms
            </Link>
            <Link to="/categories/accessories" onClick={() => setOpen(false)} className="block py-2 hover:text-gray-300 font-clash w-full text-left text-white">
              Accessories
            </Link>
          </div>
        </div>
