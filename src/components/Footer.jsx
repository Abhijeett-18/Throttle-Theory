      ...
      <div className="max-w-7xl mx-auto px-6 py-12">
        ...
        <div className="mt-8 pt-8 border-t border-gray-800 text-center text-sm text-gray-400">
          <div className="mb-4 space-y-2">
            <p className="text-lg font-semibold text-white">⚠️ Portfolio Project - Not a Real E-commerce Website</p>
            <p className="text-gray-400">This is a demo project built for educational and portfolio purposes only. No real transactions are processed.</p>
          </div>
          
          <div className="flex items-center justify-center gap-4 mb-4">
            <span className="text-gray-400">Developed by</span>
            <span className="text-white font-semibold">Abhijeet Singh</span>
            
            <div className="flex gap-4 ml-4">
              {/* GitHub Link */}
              <a 
                href="https://github.com/Abhijeett-18" 
                target="_blank" 
              ...
              {/* LinkedIn Link */}
              <a 
                href="https://www.linkedin.com/in/abhijeet-singh-6557b4310/" 
                target="_blank" 
                rel="noopener noreferrer"
                className="flex items-center gap-2 hover:text-white transition group"
              >
          ...
          <p>&copy; 2025 Throttle Theory - Portfolio Project</p>
        </div>
      </div>
    </footer>
  );
